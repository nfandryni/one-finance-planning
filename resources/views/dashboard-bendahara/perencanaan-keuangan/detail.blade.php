...
@section('content')
    ...
    <div style='margin-left:15px; margin-right:15px;'>
        <div class="row justify-content-md-center" style="align-items: center">
            <br />
            <a class='text-black mt-2' href='/dashboard-bendahara/perencanaan-keuangan'><i
        ...
        <div>
            <div class="row justify-content-md-end" style="align-items: center">
                ...
                @if (!$item_perencanaan->isEmpty())
                    <a target='_blank'
                        href="/dashboard-bendahara/perencanaan-keuangan/print-item/{{ $perencanaan_keuangan->id_perencanaan_keuangan }}"
                ...
                <tbody>
                    ...
                    @foreach ($item_perencanaan as $p)
                        <tr>
                            ...
                            <td>
                                @if ($p->status == 'Terbeli')
                                    <button disabled class="btn btn-secondary" style='margin:2px'><i class="fa-solid fa-pen"
                                            style="cursor: pointer;">
                                        </i></button>
                                    <button disabled class="btn btn-secondary" style='margin:2px'><i
                                            class="fa-solid fa-xmark"></i></button>
                                @else
                                    <a class='btn btn-primary' style='margin:2px'
                                        href="/dashboard-bendahara/item-perencanaan/edit/{{ $p->id_item_perencanaan }}"><i
                                    ...
                                    @if (!isset($perencanaan_keuangan->id_pengajuan_kebutuhan))
                                        <btn class="btn btn-danger btnHapus"
                                            idItemPerencanaan="{{ $p->id_item_perencanaan }}"><i
