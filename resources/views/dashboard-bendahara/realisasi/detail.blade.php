    ...
    <div style='margin-left:15px; margin-right:15px;'>
        ...
        <div>
            <div class="row justify-content-md-end" style="align-items: center">
                ...
                <a target='_blank' href="{{ url('/dashboard-bendahara/realisasi/print-item/' . $realisasi->id_realisasi) }}"
                    ...
                    @foreach ($item_perencanaan as $p)
                        @if ($p->status == 'Terbeli')
                            <tr>
                                ...
                                <td>{{ $p->spesifikasi }}</td>
                                <td><a
                                        href='/dashboard-bendahara/pengeluaran/detail/{{ $p->id_pengeluaran }}'>{{ $p->nama }}</a>
                                </td>
                                <td>{{ $p->status }}</td>
                                <td>
