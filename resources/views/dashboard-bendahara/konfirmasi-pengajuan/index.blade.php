...
@section('content')
    ...
    <a target='_blank' href="{{ url('/dashboard-bendahara/konfirmasi-pengajuan/print') }}" style='position:absolute; width:130px; right:30px;' class='btn btn-warning'>
      ...
      <ul>
          <div>
            ...
            <div>
                <li>
                    <b>Difilterisasi</b>
                    <p> <b>Bendahara</b> telah melakukan <b>filterisasi</b> dan <b>konfirmasi</b> terhadap pengajuan kebutuhan yang diajukan.</p>
                </li>
            </div>
            <div>
                <li>
                <b> Dikonfirmasi</b>
                    <p> <b>Admin</b> melakukan  <b>konfirmasi</b> terhadap pengajuan kebutuhan yang sudah difilterisasi oleh Bendahara.</p>
                </li>
            </div>
            <div>
                <li>
                                ...
                                @foreach ($pengajuan_kebutuhan as $s)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                           ...
                                           <a  href='/dashboard-bendahara/konfirmasi-pengajuan/detail/{{$s->id_pengajuan_kebutuhan}}'><i class="fa-solid fa-circle-info fa-lg" style="color: #000000;"></i></a>
                                            <btn class="btnHapus" style="cursor: pointer" idPengajuanKebutuhan="{{ $s->id_pengajuan_kebutuhan }}"><i class="fa-solid fa-trash"></i></btn>
                                            @endif
                                        </td>
                                    </tr>
                                @endforeach 
        ...
        $('.DataTable tbody').on('click', '.btnHapus', function(a) {
            ...
            swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        type: 'POST',
                        url: '/dashboard-bendahara/konfirmasi-pengajuan/tolak-pengajuan/'+idPengajuanKebutuhan,
                        data: { 
                        ...
                        success: function(data) {
                            if (data.success) {
                                swal.fire('Pengajuan kebutuhan berhasil ditolak!', '', 'success').then(function() {
                                location.reload();
                                });
                            }
                        }
